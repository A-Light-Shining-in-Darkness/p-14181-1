...
public class Post extends BaseEntity {
    ...
    public void checkActorCanModify(Member actor) {
        if (!actor.equals(this.author)) throw new ServiceException("403-1", "%d번 글 수정권한이 없습니다.".formatted(getId()));
    }

    public void checkActorCanDelete(Member actor) {
        if (!actor.equals(this.author)) throw new ServiceException("403-2", "%d번 글 삭제 권한이 없습니다.".formatted(getId()));
    }
}
